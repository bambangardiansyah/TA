...
<body data-spy="scroll" data-target=".navbar-nav">
    ...
    <div class="hero-aria" id="home">
            ...
            <div class="hero-content h-100">
                <div class="d-table">
                    <div class="d-table-cell">
                        <h2 class="text-uppercase" id="rumahseniman">Rumahnya <br> Seniman</h2>
                        ...
                        <a href="#portfolio" class="button smooth-scroll">Jelajahi Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="hero-area-slids owl-carousel">
            ...
            <div class="single-slider">
                <!-- Single Background -->
                <div class="slider-bg" style="background-image: url(assets/images/hero-area/img-3.png)"></div>
                <!-- // Single Background -->
            </div>
        </div>
        <!-- // Hero Area Slider -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2>Kenapa pilih ArtDex?</h2>
                        <p>Kami menyediakan tempat bagi para seniman untuk mempromosikan karyanya</p>
                    </div>
                </div>
            </div>
            <!-- //Section Title -->
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="single-why-me why-me-left">
                        ...
                        <h4>Penggunaan yang mudah</h4>
                        <p>Kamu cukup memasukkan foto dan deskripsi dari karyamu, kami akan membuatkan lamannya secara otomatis</p>
                    </div>
                </div>
                <!-- // Single Why choose me -->
                ...
                <div class="col-md-6">
                    <div class="single-why-me why-me-right">
                        ...
                        <h4>Karya lebih mudah dikenal</h4>
                        <p>Kami akan memunculkan karya mu pada laman beranda utama Artdex dan bisa secara langsung dikunjungi oleh user lainnya</p>
                    </div>
                </div>
                <!-- // Single Why choose me -->
                ...
                <div class="col-md-6">
                    <div class="single-why-me why-me-left">
                        ...
                        <h4>Bebas dari postingan tidak pantas</h4>
                        <p>Laporkan postingan yang dinilai tidak pantas dan kami akan menghapusnya</p>
                    </div>
                </div>
                <!-- // Single Why choose me -->
                ...
                <div class="col-md-6">
                    <div class="single-why-me why-me-right">
                        ...
                        <p>Cukup dengan Rp.10.000 anda akan memiliki akses tak terbatas pada jumlah postingan</p>
                    </div>
                </div>
                <!-- // Single Why choose me -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 co col-md-6 l-md-6 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="08">0</span>X</h2>
                        <p>Postingan Gratis</p>
                    </div>
                </div>
                <!-- // Single Fact Counter -->
                <!-- Single Fact Counter -->
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="100000">0</span>X</h2>
                        <p>Postingan Premium</p>
                    </div>
                </div>
                <!-- // Single Fact Counter -->
                <!-- Single Fact Counter -->
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="04">0</span></h2>
                        <p>Creator</p>
                    </div>
                </div>
                <!-- // Single Fact Counter -->
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="100">0</span>+</h2>
                        <p>Karya</p>
                    </div>
                </div>
                <!-- // Single Fact Counter -->
    ...
    <!-- ====== Team Section ====== -->
    <section class="section-padding pb-70 team-area" id="team">
        <div class="container" id="teamates">
            <!-- Section Title -->
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2>TIM KAMI</h2>
                        <p>Kami bersama-sama membangun aplikasi ini</p>
                    </div>
                </div>
            </div>
            <!-- //Section Title -->
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/img-1.jpeg)">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/img-2.jpeg)">
                            <div class="team-social">
                                <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
                        ...
                        <div class="team-content">
                            <h4>Rajwa Ataya</h4>
                            <span>Mobile Front-End Developer</span>
                        </div>
                    </div>
                </div>
                <!-- // Single Team -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/img-3.jpeg)">
                            <div class="team-social">
                                <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/img-4.jpeg)">
                            <div class="team-social">
                                <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
    ...
    <section class="section-padding pb-70 pricing-area" id="pricing"> 
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2>Tingkatkan akses anda</h2>
                        <p>Buat batas upload mu menjadi tak terbatas dengan berlangganan premium</p>
                    </div>
                </div>
            </div>
            <!-- //Section Title -->
            <div class="row" id="pricingrow">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single-price-box text-center">
                        ...
                        <ul>
                            <li>8x Unggah</li>
                            <li>Akses Komentar</li>
                            <li>Edit Profile</li>
                            <li>Jelajahi tak terbatas</li>
                        </ul>
                        <a href="#" class="button">Gunakan Sekarang</a>
                    </div>
                </div>
                <!-- // Single Price Box -->
                <!-- Single Price Box -->
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <div class="section-title text-center">
                        <h2>Hubungi kami</h2>
                        <p>Kami bersedia menerima kritik dan saran anda, silahkan isi form dibawah dan hubungi kami!</p>
                    </div>
                </div>
            </div>
            <!-- //Section Title -->
